#!/usr/bin/env python3
"""
Optimized WAF Performance Tester - Reduced Outliers
...
class OptimizedWAFLogsPerformanceTester:
    ...
    def save_waf_csv_summary(self, results, queries, filename='waf_performance_summary_optimized.csv'):
...
def main():
    ...
    tester = OptimizedWAFLogsPerformanceTester(
        ENDPOINT,
        USERNAME,
        PASSWORD,
        TEST_ITERATIONS,
    ...
    queries = tester.parse_waf_queries_file('/Users/aaarone/Documents/Code/ppl_performance_analysis/ppl_vs_dsl_performance/ppl_vs_dsl_performance/waf/waf_ppl_queries.json')
    ...
    if results:
        ...
        with open('waf_performance_results_optimized.json', 'w') as f:
