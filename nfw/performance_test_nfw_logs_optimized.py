#!/usr/bin/env python3
"""
Optimized NFW Performance Tester - Reduced Outliers
...
class OptimizedNFWLogsPerformanceTester:
    ...
    def save_nfw_csv_summary(self, results, queries, filename='nfw_performance_summary_optimized.csv'):
...
def main():
    ...
    tester = OptimizedNFWLogsPerformanceTester(
        ENDPOINT,
        USERNAME,
        PASSWORD,
        TEST_ITERATIONS,
    ...
    queries = tester.parse_nfw_queries_file('/Users/aaarone/Documents/Code/ppl_performance_analysis/ppl_vs_dsl_performance/ppl_vs_dsl_performance/nfw/nfw_ppl_queries.json')
    ...
    if results:
        ...
        with open('nfw_performance_results_optimized.json', 'w') as f:
