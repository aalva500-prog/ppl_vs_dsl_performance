...
class ImprovedVPCLogsPerformanceTester:
    ...
    def parse_vpc_queries_file(self, file_path):
        """Parse VPC queries file - same as before"""
    ...
    def save_vpc_csv_summary(self, results, queries, filename='vpc_performance_summary_improved.csv'):
...
def main():
    ...
    tester = ImprovedVPCLogsPerformanceTester(
        ENDPOINT,
        USERNAME,
        PASSWORD,
        TEST_ITERATIONS,
    ...
    if results:
        ...
        with open('vpc_performance_results_improved.json', 'w') as f:
            json.dump(results, f, indent=2)
        print(f"\nResults saved to vpc_performance_summary_improved.csv and vpc_performance_results_improved.json")
